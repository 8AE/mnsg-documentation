---
title: "Initialize Congo model part 1"
sidebar_label: "func_080066B0_6B9950"
slug: "/functions/func_080066B0_6B9950"
description: "Initializes Congo animated model part 1 of six."
---

`func_080066B0_6B9950` · **Function**

Initializes Congo animated model part 1 of six.

| Runtime address | ROM address | Section |
| --- | --- | --- |
| `0x080066B0` | `0x006B9950` | `.file_29` |
...
The spin animation associated with part index 0 is clip 12. Part numbers identify this constructor set; a specific anatomical limb name has not been established.
...
RECOMP_HOOK("func_080066B0_6B9950")
