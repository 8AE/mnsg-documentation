---
title: "Initialize Congo model part 5"
sidebar_label: "func_08006ED0_6BA170"
slug: "/functions/func_08006ED0_6BA170"
description: "Initializes Congo animated model part 5 of six."
---

`func_08006ED0_6BA170` · **Function**

Initializes Congo animated model part 5 of six.

| Runtime address | ROM address | Section |
| --- | --- | --- |
| `0x08006ED0` | `0x006BA170` | `.file_29` |
...
The spin animation associated with part index 4 is clip 16. Part numbers identify this constructor set; a specific anatomical limb name has not been established.
...
RECOMP_HOOK("func_08006ED0_6BA170")
