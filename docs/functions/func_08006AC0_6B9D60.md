---
title: "Initialize Congo model part 3"
sidebar_label: "func_08006AC0_6B9D60"
slug: "/functions/func_08006AC0_6B9D60"
description: "Initializes Congo animated model part 3 of six."
---

`func_08006AC0_6B9D60` · **Function**

Initializes Congo animated model part 3 of six.

| Runtime address | ROM address | Section |
| --- | --- | --- |
| `0x08006AC0` | `0x006B9D60` | `.file_29` |
...
The spin animation associated with part index 2 is clip 14. Part numbers identify this constructor set; a specific anatomical limb name has not been established.
...
RECOMP_HOOK("func_08006AC0_6B9D60")
