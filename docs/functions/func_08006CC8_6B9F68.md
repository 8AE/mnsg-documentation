---
title: "Initialize Congo model part 4"
sidebar_label: "func_08006CC8_6B9F68"
slug: "/functions/func_08006CC8_6B9F68"
description: "Initializes Congo animated model part 4 of six."
---

`func_08006CC8_6B9F68` · **Function**

Initializes Congo animated model part 4 of six.

| Runtime address | ROM address | Section |
| --- | --- | --- |
| `0x08006CC8` | `0x006B9F68` | `.file_29` |
...
The spin animation associated with part index 3 is clip 15. Part numbers identify this constructor set; a specific anatomical limb name has not been established.
...
RECOMP_HOOK("func_08006CC8_6B9F68")
